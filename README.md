...
```bash
wget https://github.com/jiro4989/textimg/releases/download/v3.2.2/textimg_3.2.2_amd64.deb
sudo dpkg -i ./*.deb
```
...
```bash
sudo yum install https://github.com/jiro4989/textimg/releases/download/v3.2.2/textimg-3.2.2-1.el7.x86_64.rpm
```
