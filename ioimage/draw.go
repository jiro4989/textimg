...
func drawText(img *image.RGBA, x, y int, r rune, fgCol, bgCol color.RGBA, face, emojiFace font.Face, emojiDir string, useEmoji bool) {
...
func drawLabel(img *image.RGBA, x, y int, r rune, col color.RGBA, face font.Face) {
	...
	d := &font.Drawer{
		Dst:  img,
		Src:  image.NewUniform(c.RGBA(col)),
		Face: face,
		Dot:  point,
	}
